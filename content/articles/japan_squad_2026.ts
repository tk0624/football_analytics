    ...
    },
    {
      ...
      text: {
        ...
        en:
          ...
          "Takefusa Kubo, on the verge of returning from injury, brings creative quality and a sustained La Liga record that no one else in the squad can match — he is a certainty when fit. His return does, however, put Yuto Suzuki — who featured against Scotland — in a more uncertain position. Suzuki has genuine quality in the final third and as a carrier, but the established core of this national team is built around players who can operate at high intensity in both phases of the game, and that bar remains the key reference point going forward.\n\n" +
    ...
    { type: "h2", text: { ja: "まとめ", en: "Summary" } },
    {
      ...
      text: {
        ...
        en:
          ...
          "On current evidence, the ten players who scored 4.5 or above — Zion Suzuki, Shogo Taniguchi, Junya Ito, Keito Nakamura, Daichi Kamada, Kaishu Sano, Kaoru Mitoma, Ritsu Doan, Ayase Ueda, and Daizen Maeda — are the clearest cases for inclusion. One storyline worth watching: Hidemasa Morita scores highly in this metric and is still competing in the Champions League — whether that translates into a call-up is one of the more intriguing subplots heading into the final selection.\n\n" +
